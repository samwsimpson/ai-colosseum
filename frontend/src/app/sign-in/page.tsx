...
// (optional but helpful) prevents static prerender
      ...
      <main className="w-full max-w-md p-6 rounded-2xl bg-neutral-900 shadow-lg">
        ...
        >
          ...
          <svg className="w-5 h-5" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
            <path fill="#FFC107" d="M43.611 20.082H42V20H24v8h11.305C33.876 31.657 29.35 35 24 35c-7.18 0-13-5.82-13-13s5.82-13 13-13c3.31 0 6.31 1.23 8.59 3.24l5.66-5.66C34.84 3.02 29.65 1 24 1 11.85 1 2 10.85 2 23s9.85 22 22 22c11 0 21-8 21-22 0-1.39-.2-2.81-.49-4.14z"/>
            <path fill="#4285F4" d="M6.305 14.691l6.571 4.817C14.33 16.377 18.8 12 24 12c3.31 0 6.31 1.23 8.59 3.24l5.66-5.66C34.84 3.02 29.65 1 24 1 15.27 1 7.64 5.64 3.34 12.36l2.965 2.331z"/>
            <path fill="#FBBC05" d="M24 45c5.29 0 10.13-1.94 13.86-5.26l-6.4-5.24C29.9 35.46 27.15 36.5 24 36.5c-5.32 0-9.84-3.61-11.45-8.47l-6.63 5.12C9.2 40.63 16.09 45 24 45z"/>
            <path fill="#EA4335" d="M43.611 20.082H42V20H24v8h11.305c-1.21 3.157-4.22 5.5-7.305 5.5-5.32 0-9.84-3.61-11.45-8.47l-6.63 5.12C11.47 37.75 17.38 41 24 41c11 0 21-8 21-22 0-1.39-.2-2.81-.49-4.14z"/>
          </svg>
